...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '2ed4d7ba2d69428487896e56ae9f5d2a',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，欢迎来到CNSTools🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'CNSTools', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '祝人均CNS!', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cnstools.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'CNS, cnstools', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'cnstools@163.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/3546640522677145', // B站主页
  ...
  WIDGET_PET_SWITCH_THEME: process.env.NEXT_PUBLIC_WIDGET_PET_SWITCH_THEME || fasle, // 点击宠物挂件切换博客主题
